        ...
        >
          {skillCategories.map((cat, idx) => (
            <motion.div key={idx} variants={staggerItem}>
              <Card className="relative flex flex-col h-full overflow-hidden rounded-3xl border border-white/20 bg-white/5 backdrop-blur-xl shadow-2xl hover:scale-[1.03] transition-transform duration-300">
