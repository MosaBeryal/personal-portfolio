...
export function EducationSection() {
  ...
  return (
    <section id="education" ref={sectionRef} className="relative overflow-hidden py-24 bg-card">
      {/* Animated Blobs */}
          ...
          <Card className="relative border-l-4 border-primary shadow-lg bg-white/10 backdrop-blur-md">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                <strong>Key Courses:</strong> Data Structures & Algorithms, Database Management, Web Engineering.
              </p>
              ...
              >
                {courses.map((course, idx) => (
                  ...
                  >
                    <course.icon className={`h-8 w-8 mx-auto mb-3 ${course.color}`} />
                    <div className="text-base font-medium text-foreground">{course.name}</div>
                  </motion.div>
                ))}
              </motion.div>
            </CardContent>
